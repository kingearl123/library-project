...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2026 at 01:43 PM
...
ALTER TABLE `peminjaman`
  ...
  ADD KEY `fk_peminjaman_mahasiswa` (`nim`),
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `fk_peminjaman_mahasiswa` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`),
